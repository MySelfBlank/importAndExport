...
//        String newFileName = clearBracket(fileName, '(', ')');
        PathUtil.baseInfoDir=path;
        //对字段的导入
        ...
        cn.hutool.json.JSON parseDef = JSONUtil.parse(IdCache.modelDefNewIdAndOldId);
        ...
        cn.hutool.json.JSON parseModel = JSONUtil.parse(modelNewIdAndOldId);
