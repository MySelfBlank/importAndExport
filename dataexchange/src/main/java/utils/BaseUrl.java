...
public class BaseUrl {
    ...
    public static String DATASTORE_URL = "http://bt1.geosts.ac.cn/api/dae/datastore";
    //"http://bt1.geosts.ac.cn/api/dae/datastore";
    public static String MODEL_URL = "http://bt1.geosts.ac.cn/api/dae/model-service/model";
    //"http://bt1.geosts.ac.cn/api/dae/model-service/model";
    public static String HDFS_URL = "http://bt1.geosts.ac.cn/api/dae/hdfs-service/hdfs";
    //"http://bt1.geosts.ac.cn/api/dae/hdfs-service/hdfs";
    public static String GEOMESA_URL = "http://bt1.geosts.ac.cn/api/dae/geomesa-service/geomesa";
    public static String UC_URL = "http://bt1.geosts.ac.cn/api/uc";
